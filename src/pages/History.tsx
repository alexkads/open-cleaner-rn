...
export default function History() {
  const [filter, setFilter] = useState<'all' | 'quick' | 'deep' | 'custom'>(
    'all'
  )
  ...
  const [selectedRecord, setSelectedRecord] = useState<CleaningHistory | null>(
    null
  )
                ...
                {records.length === 0 ? (
                  <>
                    ...
                    <div className="text-sm">
                      Start cleaning to see your history here
                    </div>
                  </>
                ) : (
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        >
                          <p className="font-bold text-primary">
                            {uiRecord.spaceCleaned}
                          </p>
                          <p className="text-xs text-gray-400">
                            {record.files_deleted} items
                          </p>
                        </motion.div>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={getTypeColor(selectedRecord.type).split(' ')[1]}
                  >
                    {selectedRecord.type}
                  </span>
                </div>
                <div className="flex justify-between">
                  ...
                  <span className="text-success font-bold">
                    {formatBytes(selectedRecord.space_cleaned)}
                  </span>
                </div>
                <div className="flex justify-between">
