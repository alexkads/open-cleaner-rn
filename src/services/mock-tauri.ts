...
const MOCK_SCAN_RESULTS: Record<string, ScanResult[]> = {
  expo: [
    {
      path: '/Users/dev/.expo/cache/temp1',
      size: 1024 * 1024 * 50,
      file_type: 'cache',
      can_delete: true,
    },
    {
      path: '/Users/dev/.expo/cache/temp2',
      size: 1024 * 1024 * 25,
      file_type: 'cache',
      can_delete: true,
    },
  ...
  metro: [
    {
      path: '/tmp/metro-cache/bundle1',
      size: 1024 * 1024 * 30,
      file_type: 'cache',
      can_delete: true,
    },
    {
      path: '/tmp/metro-cache/bundle2',
      size: 1024 * 1024 * 15,
      file_type: 'cache',
      can_delete: true,
    },
  ...
  npm: [
    {
      path: '~/.npm/_cacache/index-v5/1a/2b',
      size: 1024 * 1024 * 100,
      file_type: 'cache',
      can_delete: true,
    },
    {
      path: '~/.npm/_cacache/index-v5/3c/4d',
      size: 1024 * 1024 * 75,
      file_type: 'cache',
      can_delete: true,
    },
  ...
  ios: [
    {
      path: '~/Library/Developer/Xcode/DerivedData/build1',
      size: 1024 * 1024 * 200,
      file_type: 'build',
      can_delete: true,
    },
  ...
  watchman: [
    {
      path: '/usr/local/var/run/watchman/logs/watchman.log',
      size: 1024 * 1024 * 10,
      file_type: 'log',
      can_delete: true,
    },
  ...
  temp: [
    {
      path: '/tmp/react-native-temp1',
      size: 1024 * 1024 * 20,
      file_type: 'temp',
      can_delete: true,
    },
    {
      path: '/tmp/react-native-temp2',
      size: 1024 * 1024 * 15,
      file_type: 'temp',
      can_delete: true,
    },
  ...
  reactNative: [
    {
      path: '~/.rncache/metro-cache',
      size: 1024 * 1024 * 120,
      file_type: 'cache',
      can_delete: true,
    },
    {
      path: '/tmp/react-native-packager-cache',
      size: 1024 * 1024 * 80,
      file_type: 'cache',
      can_delete: true,
    },
  ...
  hermes: [
    {
      path: '~/Library/Caches/com.facebook.react.native/hermes',
      size: 1024 * 1024 * 90,
      file_type: 'cache',
      can_delete: true,
    },
    {
      path: '/tmp/hermes-compile-cache',
      size: 1024 * 1024 * 45,
      file_type: 'cache',
      can_delete: true,
    },
  ...
  androidStudio: [
    ...
    {
      path: '~/Library/Logs/AndroidStudio',
      size: 1024 * 1024 * 35,
      file_type: 'log',
      can_delete: true,
    },
  ...
  buildArtifacts: [
    {
      path: '~/Desktop/app-release.apk',
      size: 1024 * 1024 * 45,
      file_type: 'build',
      can_delete: true,
    },
    {
      path: '~/Documents/app.ipa',
      size: 1024 * 1024 * 68,
      file_type: 'build',
      can_delete: true,
    },
...
export class MockTauriService {
  ...
  static async scanDockerContainers(): Promise<ScanResult[]> {
    await delay(1500)
    return MOCK_SCAN_RESULTS.docker.filter(
      item => item.file_type === 'docker_container'
    )
  }
  ...
  static async scanDockerImages(): Promise<ScanResult[]> {
    await delay(1000)
    return MOCK_SCAN_RESULTS.docker.filter(
      item => item.file_type === 'docker_image'
    )
  }
  ...
  static async scanNodeModules(projectPath: string): Promise<ScanResult[]> {
    ...
    return [
      {
        path: `${projectPath}/node_modules/.cache`,
        size: 1024 * 1024 * 250,
        file_type: 'cache',
        can_delete: true,
      },
